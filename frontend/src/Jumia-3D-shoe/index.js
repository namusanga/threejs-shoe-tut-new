export function productDetailsFunc() {
  
  function ClickedDot (count)  {
    SwitchActiveDot(count);
    const shoe3D = document.getElementById("3d-dom");
  ...
  function SwitchActiveDot (count)  {
    if (count === 1) {
